...
# Reformatted multi-line to prevent SyntaxErrors
PBQ_DB = {
    1: {
        "topic": "Network Ports",
    ...
    11: {
        "topic": "Digital Certificates PKI",
    ...
    12: {
        "topic": "Firewall ACL Troubleshooting",
